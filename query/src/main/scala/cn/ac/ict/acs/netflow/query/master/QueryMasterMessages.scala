...
import cn.ac.ict.acs.netflow.MasterMessage

sealed trait QueryMasterMessage extends MasterMessage
...
object QueryMasterMessages {
  ...
  case class ScheduleJob(jobId: String) extends QueryMasterMessage
}
