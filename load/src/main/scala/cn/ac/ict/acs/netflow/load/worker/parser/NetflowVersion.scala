 ...
 * -----------------------------------
 */
object V9Parser extends NetflowVersion {
    ...
    flowsetId match {
      ...
      case 0 =>
        ...
        while (curPos != stopPos) {
          ...
          val template = new Template(tempId, tempFields).updateTemplate(data)
 ...
 *
 */
object V5Parser extends NetflowVersion {
