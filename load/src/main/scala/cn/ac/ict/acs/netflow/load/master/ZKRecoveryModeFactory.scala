...
class LoadMasterZKPersistenceEngine(conf: NetFlowConf, serialization: Serialization)
  extends ZooKeeperPersistenceEngine(conf, serialization) with MasterPersistenceEngine

class LoadMasterBHPersistenceEngine extends BlackHolePersistenceEngine with MasterPersistenceEngine
