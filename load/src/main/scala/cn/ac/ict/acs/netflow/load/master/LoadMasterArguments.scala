...
class LoadMasterArguments(args: Array[String], conf: NetFlowConf) {
  ...
  if (System.getenv("NETFLOW_LOAD_MASTER_HOST") != null) {
    host = System.getenv("NETFLOW_LOAD_MASTER_HOST")
  }
  if (System.getenv("NETFLOW_LOAD_MASTER_PORT") != null) {
    port = System.getenv("NETFLOW_QUERY_MASTER_PORT").toInt
  }
  if (System.getenv("NETFLOW_LOAD_MASTER_WEBUI_PORT") != null) {
    webUiPort = System.getenv("NETFLOW_LOAD_MASTER_WEBUI_PORT").toInt
  }
